...
- the arrow key that kinda helps you click buttons to see their states, but not all buttons are clickable, and doesn't account for keyboard states (e.g. if you want to disable key popups)
